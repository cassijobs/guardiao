...
async function publicarTudo(){
  ...
  ar.file("config.json",JSON.stringify({versao:7,sistema:"O Escriba Studio 10.3 — Cache e Rascunho Corrigidos",geradoEm:new Date().toISOString(),lotes:configLotes},null,2));
