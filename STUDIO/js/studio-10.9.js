...
async function gerarLote(){
  ...
  ar.file("config.json",JSON.stringify({
    ...
    sistema:"O Escriba Studio 10.9 — Publicação de novo lote",
...
async function publicarTudo(){
  ...
  ar.file("config.json",JSON.stringify({versao:Date.now(),sistema:"O Escriba Studio 10.9 — Biblioteca completa",geradoEm:new Date().toISOString(),lotes:configLotes},null,2));
