...
const Palco = {
    ...
    iniciar() {
        ...
        if (!this.elemento) {
            throw new Error("Elemento #guardiao não encontrado.");
        }
    },
    ...
    mostrarTexto(texto) {
        return new Promise(resolve => {
            ...
            setTimeout(() => {
                this.elemento.innerHTML = `<div>${texto}</div>`;
    ...
    pedirNome(pergunta) {
        return new Promise(resolve => {
            this.elemento.innerHTML = `
                ...
                <button class="botao" id="confirmar">Continuar</button>
            `;
    ...
    mostrarBotoes(pergunta, positivo, negativo) {
        return new Promise(resolve => {
            this.elemento.innerHTML = `
                ...
                <div id="areaBotoes">
                    <button class="botao oculto" id="sim">${positivo}</button>
                    <button class="botao oculto" id="nao">${negativo}</button>
                </div>
            `;
