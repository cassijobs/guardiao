...
const JORNADA1 = [

    {
        ...
        cenas: [
            ...
            {
                tipo: "jornada",
                rotulo: "Primeira Jornada",
                titulo: "O Encontro Consigo Mesmo",
                frase: "Toda transformação começa quando enxergamos aquilo que antes passava despercebido.",
                texto: [
                    "Hoje nossa caminhada começa.",
                    "Não há nada que você precise provar.",
                    "Nem respostas certas para encontrar.",
                    "Apenas disposição para olhar um pouco mais para si mesmo.",
                    "Daremos um passo de cada vez.",
                    "Estarei aqui."
                ],
                botao: "Começar a caminhada"
            },
...

    {
        ...
        cenas: [
            ...
            {
                tipo: "fim",
                texto: "Amanhã continuaremos nossa caminhada."
            }
